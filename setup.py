...
>python3 -m pip install --index-url https://test.pypi.org/simple/ --no-deps <module_name>

To complete a local install from setup.py, execute
>python setup.py install        - to get .egg file
>ptrgon setup.py install_lib    - to get copies of all .py files and the module directories.
"""
